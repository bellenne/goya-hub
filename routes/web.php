...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/games/{game}/notes', [GameNoteController::class, 'index'])->name('games.notes.index');
    Route::post('/games/{game}/notes', [GameNoteController::class, 'store'])->name('games.notes.store');
    Route::patch('/games/{game}/notes/{note}', [GameNoteController::class, 'update'])->name('games.notes.update');
