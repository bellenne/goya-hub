...
<template>
    <section>
        <header>
            <p class="fantasy-kicker text-teal-200/80">Безопасность</p>
            <h2 class="mt-2 text-2xl font-semibold text-teal-50">Смена пароля</h2>
            <p class="mt-3 text-sm leading-6 text-stone-400">
                Используйте длинный и уникальный пароль, чтобы защитить аккаунт.
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton :disabled="form.processing">Обновить пароль</PrimaryButton>
